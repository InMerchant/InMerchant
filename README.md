...
<div>• 인공지능 및 빅데이터 기술을 활용한 교육에 참여해 실전 경험을 쌓고 전자정부 표준프레임워크 개발자 교육을 통해 JAVA와 신기술을 접목한 프로젝트 작업 가능 </div>
<div>• 소프트웨어 개발 뿐만 아니라 자가발전을 위한 교내 프로그램, 동아리 활동 그리고 네이버 커넥트 주관 멘토링 수업을 통한 뚜렷한 의견전달 및 리더십 능력을 갖춤. </div>
<div>• 컴퓨터공학 전공을 이어가며 보다 전문적이고 다양한 지식과 기술을 습득하는 도전 의식이 강한 개발자. </div>

<h3>자격증</h3>
<div>정보처리기사 (2024.06 취득)</div>
<br>

<h3>🏆수상이력🏆</h3>
<div>(2024년) 한국디지털콘텐츠학회 하계종합학술대회 수상 (동상)</div>
